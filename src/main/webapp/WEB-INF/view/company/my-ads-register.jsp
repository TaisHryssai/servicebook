            ...
            <div class="">
                <div class="row">
                    <div class="col s12 breadcrumbs" style="margin-top: 20px">
                        ...
                        <a href="${pageContext.request.contextPath}/minha-conta/empresa/meus-anuncios">Meus anúncios</a> &gt;
                        Novo Anúncio
                    </div>
                </div>
                <div class="section">
                    ...
                    <div class="row">
                        ...
                        <div class="col s12 type-individual" id="type-individual">
                            <form action="minha-conta/empresa/meus-anuncios/novo/individual"
                                  method="post">
                                ...
                                <div class="right">
                                    <a href="minha-conta/empresa/meus-anuncios" class="btn-flat">Cancelar</a>
                                    <button type="submit"
...
<script>
    ...
    $('#expertise-select').change(function () {
        ...
        let url = 'minha-conta/empresa/especialidades/' + expertiseId + '/servicos';
