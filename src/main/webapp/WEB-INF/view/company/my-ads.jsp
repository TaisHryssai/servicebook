          ...
          <div class="row">
            ...
            <div class="col s12">
              <div class="center spacing-buttons">
                <a class="waves-effect waves-light btn" href="minha-conta/empresa/meus-anuncios/novo">
                  NOVO ANÚNCIO
                </a>
              </div>
            </div>
            ...
            <c:if test="${not empty servicesIndividuals}">
                ...
                <div class="col s12">
                  ...
                  <hr>
                  <a href="minha-conta/empresa/meus-anuncios/individuais" class="btn-flat btn_view">ver mais <i class="material-icons right">navigate_next</i></a>
                </div>
...
<script>
    $(function () {
        ...
        $('#expertise-select-filter').change(function () {
            ...
            let url = 'minha-conta/empresa/meus-anuncios/especialidade/' + expertiseId;
