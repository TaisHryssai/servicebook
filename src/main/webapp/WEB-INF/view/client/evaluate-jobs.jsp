...
<t:template-side-nav title="Avaliar Solicitação">
    <jsp:body>
            ...
            <div class="col s12 professional-data">
                <div class="image-professional">
                    <c:choose>
                        ...
                        <c:otherwise>
                            <img src="assets/resources/images/no-photo.png" class="profile-picture"
                                 alt="Sem foto de perfil">
                        </c:otherwise>
                    </c:choose>
                </div>
                <p class="professional-name"> <b>Profissional: </b> <i>  ${professional.name} </i> </p>

                <div class="row">
                    <div class="col s12 m6 center">
                        <p> <b>Pedido solicitado em:</b> <i> ${hiredDate} </i> </p>
                    </div>

                    <div class="col s12 m6 center">
                        <p> <b>Concluído:</b> <i> ${finishDate} </i> </p>
                    </div>
                </div>
            </div>


            <form action="minha-conta/cliente/avaliar/servico/${job.id}/profissional/${professional.id}" method="post" enctype="multipart/form-data">

                <div class="col s12">
                    <h6> <b>Quantas estrelas este serviço merece?</b> </h6>
                ...
                <div class="col s12 input-field">
                    <h6> <b>Caso deseje, você pode deixar seu comentário.</b> </h6>
                    <textarea id="textarea1" class="materialize-textarea" name="comment"></textarea>
                </div>

                <div class="col s12">
                    <h6> <b>Caso deseje, você pode adicionar uma foto do serviço que foi feito.</b> </h6>
