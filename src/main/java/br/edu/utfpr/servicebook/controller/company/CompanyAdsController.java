...
import br.edu.utfpr.servicebook.controller.ProfessionalHomeController;
import br.edu.utfpr.servicebook.model.dto.ExpertiseDTO;
import br.edu.utfpr.servicebook.model.dto.ProfessionalServiceOfferingDTO;
import br.edu.utfpr.servicebook.model.dto.ProfessionalServicePackageOfferingDTO;
...
@RequestMapping("/minha-conta/empresa/meus-anuncios")
@Controller
public class CompanyAdsController {
    ...
    protected ModelAndView showMyAds() throws Exception {
        ModelAndView mv = new ModelAndView("company/my-ads");
    ...
    protected ModelAndView registerMyAds() throws Exception {
        ModelAndView mv = new ModelAndView("company/my-ads-register");
...
//
    ...
    protected ModelAndView showMyAdsPackages() throws Exception {
        ModelAndView mv = new ModelAndView("company/ads/my-ads-packages");
        Optional<User> oUser = (userService.findByEmail(authentication.getEmail()));
    ...
    protected ModelAndView showMyAdsIndividuals() throws Exception {
        ModelAndView mv = new ModelAndView("company/ads/my-ads-individuals");
        Optional<User> oUser = (userService.findByEmail(authentication.getEmail()));
    ...
    protected ModelAndView showMyAdsCombineds() throws Exception {
        ModelAndView mv = new ModelAndView("company/ads/my-ads-combineds");
        Optional<User> oUser = (userService.findByEmail(authentication.getEmail()));
