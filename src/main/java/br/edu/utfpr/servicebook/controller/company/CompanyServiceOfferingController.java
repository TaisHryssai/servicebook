...
import br.edu.utfpr.servicebook.service.ProfessionalServiceOfferingService;
...
@RequestMapping("/minha-conta/empresa/servicos")
@Controller
public class CompanyServiceOfferingController {
